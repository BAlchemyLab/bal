...
class TestTransactionMethods(unittest.TestCase):
    ...
    def test_validate_transaction(self):
        ...
        example_new_tx_in_1 = new_tx_in("testId270", 0, "testSignature") # Signature will be updated
        example_new_tx_in_2 = new_tx_in("testId271", 1, "testSignature") # Signature will be updated
        example_new_tx_ins = [example_new_tx_in_1, example_new_tx_in_2]
        example_new_tx_out_1 = new_tx_out("A61B5BE06CD7FE6D95064DAC98C97C9C8D128BEFACF7EA655D4EDF5B09B7DFAB6D059DD0A64B8C3CE9A11FEDC38143819BDF9CD4BC23EDCECFBAEB7DECACC81FE84CA7DE4AD33C89C9E848A5A8E8BDFD3BEA7BB3C4F81B4D", 500)
        example_new_tx_out_2 = new_tx_out("561B5BE06CD7FE6D95064DAC98C97C9C8D128BEFACF7EA655D4EDF5B09B7DFAB6D059DD0A64B8C3CE9A11FEDC38143819BDF9CD4BC23EDCECFBAEB7DECACC81FE84CA7DE4AD33C89C9E848A5A8E8BDFD3BEA7BB3C4F81B4D", 501)
        example_new_tx_outs = [example_new_tx_out_1, example_new_tx_out_2]
        ...
        example_new_unspent_tx_out_1 = new_unspent_tx_out("testId270", 0, public_key, 500)
        example_new_unspent_tx_out_2 = new_unspent_tx_out("testId271", 1, public_key, 501)
        example_a_unspent_tx_outs = [example_new_unspent_tx_out_1, example_new_unspent_tx_out_2]
        private_key = private_key.to_der().encode('hex') # Create hex encoded private_key
        signature = sign_tx_in(example_new_transaction, 0, private_key, example_a_unspent_tx_outs) # Sign tx_ins
        example_new_transaction['tx_ins'][0]['signature'] = signature # Update the signature
        example_new_transaction['tx_ins'][1]['signature'] = signature # Update the signature
